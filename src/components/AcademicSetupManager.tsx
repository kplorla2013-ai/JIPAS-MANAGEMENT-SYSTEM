...
import { 
  AcademicYearItem, TermItem, DepartmentItem, ClassItem, HouseItem, SubjectItem, Student, Teacher 
} from '../types';
import { 
  Plus, Edit2, Trash2, CheckCircle, Search, Filter, Calendar, BookOpen, 
  Building2, School, Shield, Check, X, Sliders, AlertTriangle, Users, 
  ChevronRight, ArrowRight, Sparkles, Award
} from 'lucide-react';
import { deleteAcademicYear, deleteTerm, deleteDepartment, deleteClass, deleteHouse, deleteSubject } from '../services/dbService';
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-5 shadow-sm hover:shadow-md transition-all flex flex-col justify-between">
              <div className="space-y-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">
                    Organize Primary, JHS, Science, Arts, Languages, and assign Heads of Department (HODs).
                  </p>
                </div>
              </div>
              <div className="mt-5 pt-3 border-t border-slate-100 flex items-center justify-between">
