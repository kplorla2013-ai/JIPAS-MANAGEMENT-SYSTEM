...
export default function TeacherManager({
  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-6 space-y-6">
          <div className="flex flex-wrap justify-between items-center gap-3 pb-4 border-b border-slate-100">
            ...
            <div className="flex flex-wrap gap-2">
              <button
                onClick={() => { setQrInitialMode('office_terminal'); setIsQrTerminalOpen(true); }}
                className="px-4 py-2 bg-gradient-to-r from-slate-900 to-indigo-900 hover:from-slate-800 hover:to-indigo-800 text-white rounded-xl text-xs font-bold shadow-sm flex items-center gap-1.5 cursor-pointer transition-all border border-indigo-700/50"
              >
                <QrCode className="w-4 h-4 text-indigo-400" /> Launch Office QR Terminal
              </button>
              <button
      ...
      {/* Office QR Attendance Terminal Modal */}
