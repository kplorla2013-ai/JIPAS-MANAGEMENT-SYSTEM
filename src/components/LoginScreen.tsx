      ...
      if (matchedUserAccount) {
        ...
        setTimeout(() => {
          onLogin({
            ...
            classAssigned: matchedUserAccount.classAssigned,
            admissionNo: matchedUserAccount.admissionNo,
            allowedModules: (matchedUserAccount as any).allowedModules,
            privilege: (matchedUserAccount as any).privilege,
            avatar: matchedUserAccount.avatar || (matchedUserAccount.role === 'teacher' 
