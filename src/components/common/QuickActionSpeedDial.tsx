...
import { 
  ...
  CheckCircle2, Award, KeyRound, DollarSign, X, ChevronUp, Sparkles, MessageSquare, HardDrive
} from 'lucide-react';
...
export default function QuickActionSpeedDial({
  ...
  const teacherActions = [
    ...
    },
    {
      ...
      description: 'Export snapshots or sync academic data with Google Drive',
      icon: HardDrive,
